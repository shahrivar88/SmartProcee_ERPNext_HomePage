...
app_include_js = ["/assets/smartprocee_erpnext_homepage/js/home_manager_desk.js?v=9"]
app_include_css = ["/assets/smartprocee_erpnext_homepage/css/home_manager_desk.css?v=9"]
